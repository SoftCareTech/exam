...
<h2  style="color:green">Student Login </h2>
    ...
    <input  type="text" class="form-control"  name="aClass" >
    </div>
<div class="form-group">
     <label> current  </label>
    <input  type="text" class="form-control"  name="cClass" >
    </div>
    <div class="form-group">
...
$name=$_POST['fullName'];$address=$_POST['address'];
  $phone=$_POST['phone'];   $gPhone=$_POST['gPhone'];
   ...
   $admittedSession=$_POST['aSession'];    $currentClass=$_POST['cClass'];
    $currentSession=$_POST['cSession'];   $block='no';
    $case='';      $blockMsg="";     $dateCreated=Date('Y:M:D:H:L:S');
//login validation
...
echo "A student Exist with thesame username and password <a href='viewStudent.php?c=".$stu->id."' > view the student </a>";
 }
