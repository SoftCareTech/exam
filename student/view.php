...
<h2  style="color:green">Student Detials </h2>
 ...
 <a href='edit.php?c=<?php echo $stu->id ?> '> edit </a>
    ...
    <div class="form-group">
     ...
     <?php  echo getClassName( $stu->admittedClass ) ?> 
    </div>
    <div class="form-group">
...
<div class="form-group">
     ...
     <?php  echo  getClassName($stu->currentClass ); ?> 
    </div>
    ...
    <?php  echo $stu->address  ?>   
     ...
     <a href="create.php<?php  ?>"> <font face="Papyrus"> Add new Student </font>  </a>
    </div>
